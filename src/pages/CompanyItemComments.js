...
const ITEM_CONFIG = {
  ...
  diversidade: { label: "Diversidade e Inclusão", commentKeys: ["commentDiversidade"] },
  discriminacao: { label: "Sofreu discriminação?", commentKeys: ["commentDiscriminacao"] },
  cargaHoraria: { label: "Carga Horária / Jornada de Trabalho", commentKeys: ["commentCargaHoraria"] },
  crescimento: { label: "Oportunidades de Desenvolvimento / Crescimento", commentKeys: ["commentCrescimento"] },
