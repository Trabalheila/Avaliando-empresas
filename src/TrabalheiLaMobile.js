...
function TrabalheiLaMobile({
  ...
  const campos = [
    ...
    { restrictKey: "discriminacao", label: t("Sofreu discriminação?"), icon: <FiAlertCircle className="text-cyan-700" />, iconBg: "from-cyan-50 to-sky-100 border-cyan-200", value: discriminacao, set: setDiscriminacao, comment: commentDiscriminacao, setComment: setCommentDiscriminacao },
