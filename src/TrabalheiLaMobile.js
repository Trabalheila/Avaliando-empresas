      ...
      return (
        <div className="min-h-screen bg-gradient-to-br from-purple-100 to-pink-100 flex flex-col items-center p-4">
          <div className="w-full max-w-md">
            {/* Cabeçalho */}
            <header className="text-center mb-8 bg-white/80 backdrop-blur-lg rounded-3xl p-6 shadow-xl border border-white/20">
              ...
              <div className="flex flex-col space-y-3 mb-6">
                ...
                />
                <button
                  className="w-full flex items-center justify-center bg-white text-gray-700 font-semibold py-3 px-4 rounded-xl shadow-md hover:bg-gray-100 transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                  disabled={isLoading}
                >
              ...
              {/* Card de Privacidade */}
              <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 text-purple-800 flex items-center space-x-3 shadow-inner">
                <FaLock className="text-purple-600 text-2xl" />
                <p className="text-sm font-medium">
                  Sua privacidade é garantida. Avalie de forma anônima e segura.
                </p>
              </div>
            </header>
            ...
            <section className="bg-white rounded-3xl shadow-2xl p-6 border border-slate-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Campo para nova empresa */}
                {company && company.value === "new" && (
                  <div>
                    <label
                      htmlFor="new-company-name"
                      className="block text-gray-700 text-base font-semibold mb-2"
                    >
                      Qual o nome da nova empresa?
                    </label>
                    <input
                      type="text"
                      id="new-company-name"
