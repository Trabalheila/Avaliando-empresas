...
function TrabalheiLa() {
  ...
  return (
    <div className="min-h-screen p-2 md:p-8" style={{ backgroundImage: 'url("/fundo.png")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
              ...
              <div className="flex flex-col items-center space-y-3 md:space-y-4">
                {!isAuthenticated ? (
                  <div className="w-full max-w-xs">
                    ...
                    {isLoading && <p className="text-xs md:text-sm text-gray-600 mt-2 md:mt-3 text-center animate-pulse">Autenticando com o LinkedIn...</p>}
                  </div>
                ) : (
        ...
        <div className="lg:col-span-1">
          <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-4 md:p-6 border border-white/20 lg:sticky lg:top-8">
            <div className="flex flex-col items-center mb-3 md:mb-4">
              <img src="/trofeu.png" alt="Troféu Trabalhei Lá" className="w-8 h-8 md:w-10 md:h-10 object-contain mb-1 drop-shadow-lg" />
