                ...
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs md:text-sm text-blue-50">
                      Usamos o LinkedIn ou Google apenas para verificar seu vínculo profissional.
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  ...
                  return (
                    ...
                    >
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full md:w-[90%] lg:w-[80%] border border-gray-300 p-2 rounded-lg text-xs md:text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-y max-h-32"
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-4 md:p-6 border-2 border-purple-200">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full md:w-[90%] lg:w-[80%] border-2 border-purple-300 p-3 md:p-4 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-y max-h-40 text-xs md:text-sm"
