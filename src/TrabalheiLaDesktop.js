...
function OutlinedStar({ active, onClick, size = 18, label }) {
  const outlineScale = 1.24; // Definido aqui para ser consistente
  return (
            ...
            <section className="bg-white rounded-3xl shadow-xl p-6 border border-slate-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {[
                  ...
                  { label: "Acessibilidade à Liderança", value: acessibilidadeLideranca, set: setAcessibilidadeLideranca, comment: commentAcessibilidadeLideranca, setComment: setCommentAcessibilidadeLideranca, icon: <FaUserTie className="text-indigo-500" /> },
                  ...
                  { label: "Estímulo à Inovação", value: estimulacaoOrganizacao, set: setEstimulacaoOrganizacao, comment: commentEstimulacaoOrganizacao, setComment: setCommentEstimulacaoOrganizacao, icon: <FaLightbulb className="text-orange-500" /> },
                ].map((campo, index) => (
