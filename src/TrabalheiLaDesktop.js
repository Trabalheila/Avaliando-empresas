    ...
    function TrabalheiLaDesktop({
      ...
      // ✅ CORRIGIDO: calcularMedia agora é recebida via props do Home.js
      // const calcularMedia = (emp) => { ... }; // Removido pois vem de props
      ...
      // Função auxiliar para obter URL da logo
      ...
      const currentCompany = selectedCompanyData || { company: "Selecione uma Empresa", rating: 0, contatoRH: 0, salarioBeneficios: 0, estruturaEmpresa: 0, acessibilidadeLideranca: 0, planoCarreiras: 0, bemestar: 0, estimulacaoOrganizacao: 0 };
          ...
          <div className="w-full max-w-4xl min-w-0 mx-auto">
            ...
            <header className="bg-blue-200 rounded-3xl shadow-xl p-6 mb-8 border border-blue-300 flex flex-col md:flex-row items-center justify-between text-center md:text-left">
              ...
              <div className="flex flex-col items-center md:items-start mb-4 md:mb-0 md:w-1/4">
                <img
                  src={getCompanyLogoUrl(currentCompany.company)}
                  alt={`${currentCompany.company} Logo`}
                  className="w-24 h-auto mb-2"
                />
                <p className="text-xl font-bold text-slate-700">NOTA {currentCompanyMedia}/5</p>
              </div>
            ...
            <section className="bg-white rounded-3xl shadow-2xl p-6 border border-slate-200 mt-6">
              ...
              <div className="mb-6">
                ...
                <Select
                  ...
                  onChange={(selectedOption) => setCompany(selectedOption)} // ✅ CORRIGIDO: Passando o objeto completo
