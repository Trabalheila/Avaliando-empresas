...
function TrabalheiLaDesktop({
  ...
  const campos = [
    ...
    { restrictKey: "discriminacao", label: t('Sofreu discriminação?'), value: discriminacao, set: setDiscriminacao, comment: commentDiscriminacao, setComment: setCommentDiscriminacao, icon: <FiAlertCircle className="text-teal-600" />, iconBg: "from-teal-50 to-cyan-100 border-teal-200" },
