...
export default function WorkPeriodPicker({
  ...
  const selectClass =
    "rounded-md border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 px-2 py-1 text-sm text-slate-800 dark:text-slate-100";

  return (
    <div className="bg-purple-50 dark:bg-slate-800 border border-purple-200 dark:border-slate-700 rounded-xl p-3">
      ...
      <div className="space-y-2 text-sm text-slate-700 dark:text-slate-200">
        <div className="flex flex-wrap items-center gap-2">
          <label className="font-semibold w-12">Início:</label>
          <select
        ...
        <div className="flex flex-wrap items-center gap-2">
          <label className="font-semibold w-12">Saída:</label>
          <select
